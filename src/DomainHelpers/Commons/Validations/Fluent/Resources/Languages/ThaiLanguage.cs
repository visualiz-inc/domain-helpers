...
internal class ThaiLanguage {
    ...
    public static string? GetTranslation(string key) {
        return key switch {
            ...
            "LengthValidator" =>
                "'{PropertyName}'ต้องมีจำนวนตัวอักษรอยู่ระหว่าง{MinLength}และ{MaxLength}ตัวอักษร คุณให้ข้อมูลทั้งหมด{TotalLength}ตัวอักษร",
            "MinimumLengthValidator" =>
                "จำนวนตัวอักษร'{PropertyName}'ต้องมีอย่างน้อย{MinLength}ตัวอักษร คุณให้ข้อมูลทั้งหมด{TotalLength}ตัวอักษร",
            "MaximumLengthValidator" =>
                "จำนวนตัวอักษร'{PropertyName}'ต้องเท่ากับ{MaxLength}ตัวอักษรหรือน้อยกว่า คุณให้ข้อมูลทั้งหมด{TotalLength}ตัวอักษร",
            ...
            "ExactLengthValidator" =>
                "'{PropertyName}'ต้องมีจำนวนตัวอักษร{MaxLength}ตัวอักษร คุณให้ข้อมูลทั้งหมด{TotalLength}ตัวอักษร",
            "InclusiveBetweenValidator" =>
                "'{PropertyName}'ต้องมีค่าระหว่าง{From}ถึง{To} คุณให้ข้อมูล{PropertyValue}",
            "ExclusiveBetweenValidator" =>
                "'{PropertyName}'ต้องมีค่าอยู่ระหว่างแต่ไม่รวม{From}และ{To} คุณให้ข้อมูล{PropertyValue}",
            "CreditCardValidator" => "'{PropertyName}'ไม่ใช่ตัวเลขบัตรเครดิตที่ถูกต้อง",
            "ScalePrecisionValidator" =>
                "'{PropertyName}'ต้องไม่มีจำนวนตัวเลขมากกว่า{ExpectedPrecision}ตำแหน่งทั้งหมด และมีจุดทศนิยม{ExpectedScale}ตำแหน่ง ข้อมูลมีตัวเลขค่าเต็ม{Digits}ตำแหน่งและจุดทศนิยม{ActualScale}ตำแหน่ง",
