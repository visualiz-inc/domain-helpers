    ...
    public static string? GetTranslation(string key) {
        return key switch {
            ...
            "GreaterThanOrEqualValidator" =>
                "Hodnota poľa '{PropertyName}' musí byť väčšia alebo sa rovnať '{ComparisonValue}'.",
            "GreaterThanValidator" => "Hodnota poľa '{PropertyName}' musí byť väčšia ako '{ComparisonValue}'.",
            "LengthValidator" =>
                "Dĺžka poľa '{PropertyName}' musí byť medzi {MinLength} a {MaxLength} znakmi. Vami zadaná dĺžka je {TotalLength} znakov.",
            "MinimumLengthValidator" =>
                "Dĺžka poľa '{PropertyName}' musí byť väčšia alebo rovná {MinLength} znakom. Vami zadaná dĺžka je {TotalLength} znakov.",
            "MaximumLengthValidator" =>
                "Dĺžka poľa '{PropertyName}' musí byť menšia alebo rovná {MaxLength} znakom. Vami zadaná dĺžka je {TotalLength} znakov.",
            "LessThanOrEqualValidator" =>
                "Hodnota poľa '{PropertyName}' musí byť menšia alebo sa rovnať '{ComparisonValue}'.",
            ...
            "ExactLengthValidator" =>
                "Dĺžka poľa '{PropertyName}' musí byť {MaxLength} znakov. Vami zadaná dĺžka je {TotalLength} znakov.",
            "InclusiveBetweenValidator" =>
                "Hodnota poľa '{PropertyName}' musí byť medzi {From} a {To} (vrátane). Vami zadaná hodnota je {PropertyValue}.",
            "ExclusiveBetweenValidator" =>
                "Hodnota poľa '{PropertyName}' musí byť väčšia ako {From} a menšia ako {To}. Vami zadaná hodnota {PropertyValue}.",
            "CreditCardValidator" => "Pole '{PropertyName}' nie je správné číslo kreditnej karty.",
            "ScalePrecisionValidator" =>
                "Pole '{PropertyName}' nemôže mať viac  ako {ExpectedPrecision} čísiel a {ExpectedScale} desatinných miest. Vami bolo zadané {Digits} číslic a {ActualScale} desatinných miest.",
