...
internal class NorwegianBokmalLanguage {
    ...
    public static string? GetTranslation(string key) {
        return key switch {
            ...
            "LengthValidator" =>
                "'{PropertyName}' skal være mellom {MinLength} og {MaxLength} tegn. Du har tastet inn {TotalLength} tegn.",
            "MinimumLengthValidator" =>
                "'{PropertyName}' skal være større enn eller lik {MinLength} tegn. Du tastet inn {TotalLength} tegn.",
            "MaximumLengthValidator" =>
                "'{PropertyName}' skal være mindre enn eller lik {MaxLength} tegn. Du tastet inn {TotalLength} tegn.",
            ...
            "ExactLengthValidator" =>
                "'{PropertyName}' skal være {MaxLength} tegn langt. Du har tastet inn {TotalLength} tegn.",
            "InclusiveBetweenValidator" =>
                "'{PropertyName}' skal være mellom {From} og {To}. Du har tastet inn {PropertyValue}.",
            "ExclusiveBetweenValidator" =>
                "'{PropertyName}' skal være mellom {From} og {To} (eksklusiv). Du har tastet inn {PropertyValue}.",
            "CreditCardValidator" => "'{PropertyName}' er ikke et gyldig kredittkortnummer.",
            "ScalePrecisionValidator" =>
                "'{PropertyName}' kan ikke være mer enn {ExpectedPrecision} siffer totalt, med hensyn til {ExpectedScale} desimaler. {Digits} siffer og {ActualScale} desimaler ble funnet.",
