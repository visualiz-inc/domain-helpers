    ...
    public static string? GetTranslation(string key) {
        return key switch {
            ...
            "GreaterThanOrEqualValidator" =>
                "'{PropertyName}' moet groter zijn dan of gelijk zijn aan '{ComparisonValue}'.",
            ...
            "LessThanOrEqualValidator" =>
                "'{PropertyName}' moet kleiner zijn dan of gelijk zijn aan '{ComparisonValue}'.",
            ...
            "ExclusiveBetweenValidator" =>
                "'{PropertyName}' moet na {From} komen en voor {To} liggen. Je hebt ingevuld {PropertyValue}.",
            "InclusiveBetweenValidator" =>
                "'{PropertyName}' moet tussen {From} en {To} liggen. Je hebt ingevuld {PropertyValue}.",
            "ScalePrecisionValidator" =>
                "'{PropertyName}' mag in totaal niet meer dan {ExpectedPrecision} decimalen nauwkeurig zijn, met een grootte van {ExpectedScale} gehele getallen. Er zijn {Digits} decimalen en een grootte van {ActualScale} gehele getallen gevonden.",
            ...
            "MinimumLength_Simple" =>
                "De lengte van '{PropertyName}' moet groter zijn dan of gelijk zijn aan {MinLength} tekens.",
            "MaximumLength_Simple" =>
                "De lengte van '{PropertyName}' moet kleiner zijn dan of gelijk zijn aan {MaxLength} tekens.",
