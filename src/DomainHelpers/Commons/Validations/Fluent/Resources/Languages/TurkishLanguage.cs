    ...
    public static string? GetTranslation(string key) {
        return key switch {
            ...
            "GreaterThanOrEqualValidator" =>
                "'{PropertyName}' değeri '{ComparisonValue}' değerinden büyük veya eşit olmalı.",
            "GreaterThanValidator" => "'{PropertyName}' değeri '{ComparisonValue}' değerinden büyük olmalı.",
            "LengthValidator" =>
                "'{PropertyName}', {MinLength} ve {MaxLength} arasında karakter uzunluğunda olmalı . Toplam {TotalLength} adet karakter girdiniz.",
            "MinimumLengthValidator" =>
                "'{PropertyName}', {MinLength} karakterden büyük veya eşit olmalıdır. {TotalLength} karakter girdiniz.",
            "MaximumLengthValidator" =>
                "'{PropertyName}', {MaxLength} karakterden küçük veya eşit olmalıdır. {TotalLength} karakter girdiniz.",
            "LessThanOrEqualValidator" =>
                "'{PropertyName}', '{ComparisonValue}' değerinden küçük veya eşit olmalı.",
            ...
            "ExactLengthValidator" =>
                "'{PropertyName}', {MaxLength} karakter uzunluğunda olmalı. {TotalLength} adet karakter girdiniz.",
            "InclusiveBetweenValidator" =>
                "'{PropertyName}', {From} ve {To} arasında olmalı. {PropertyValue} değerini girdiniz.",
            "ExclusiveBetweenValidator" =>
                "'{PropertyName}', {From} ve {To} (dahil değil) arasında olmalı. {PropertyValue} değerini girdiniz.",
            "CreditCardValidator" => "'{PropertyName}' geçerli bir kredi kartı numarası değil.",
            "ScalePrecisionValidator" =>
                "'{PropertyName}', {ExpectedScale} ondalıkları için toplamda {ExpectedPrecision} rakamdan fazla olamaz. {Digits} basamak ve {ActualScale} basamak bulundu.",
