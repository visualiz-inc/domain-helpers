    ...
    public static string? GetTranslation(string key) {
        return key switch {
            ...
            "ExactLengthValidator" =>
                "'{PropertyName}' deve essere lungo {MaxLength} caratteri. Hai inserito {TotalLength} caratteri.",
            "ExclusiveBetweenValidator" =>
                "'{PropertyName}' deve essere compreso tra {From} e {To} (esclusi). Hai inserito {PropertyValue}.",
            "GreaterThanOrEqualValidator" =>
                "'{PropertyName}' deve essere maggiore o uguale a '{ComparisonValue}'.",
            "GreaterThanValidator" => "'{PropertyName}' deve essere maggiore di '{ComparisonValue}'.",
            "InclusiveBetweenValidator" =>
                "'{PropertyName}' deve essere compreso tra {From} e {To}. Hai inserito {PropertyValue}.",
            "LengthValidator" =>
                "'{PropertyName}' deve essere lungo tra i {MinLength} e {MaxLength} caratteri. Hai inserito {TotalLength} caratteri.",
            "MinimumLengthValidator" =>
                "'{PropertyName}' deve essere maggiore o uguale a {MinLength} caratteri. Hai inserito {TotalLength} caratteri.",
            "MaximumLengthValidator" =>
                "'{PropertyName}' deve essere minore o uguale a {MaxLength} caratteri. Hai inserito {TotalLength} caratteri.",
            ...
            "ScalePrecisionValidator" =>
                "'{PropertyName}' potrebbe non avere più di {ExpectedPrecision} cifre in totale, con una tolleranza per {ExpectedScale} decimali. Sono stati trovate {Digits} cifre e {ActualScale} decimali.",
