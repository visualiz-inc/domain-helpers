    ...
    internal class CroatianLanguage {
        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "LengthValidator" =>
                    "'{PropertyName}' mora biti između {MinLength} i {MaxLength} znakova. Upisali ste {TotalLength} znakova.",
                "MinimumLengthValidator" =>
                    "'{PropertyName}' mora imati duljinu veću ili jednaku {MinLength}. Unijeli ste {TotalLength} znakova.",
                "MaximumLengthValidator" =>
                    "'{PropertyName}' mora imati duljinu manju ili jednaku {MaxLength}. Unijeli ste {TotalLength} znakova.",
                ...
                "ExactLengthValidator" =>
                    "'{PropertyName}' mora sadržavati {MaxLength} znakova. Upisali ste {TotalLength} znakova.",
                "InclusiveBetweenValidator" =>
                    "'{PropertyName}' mora biti između {From} i {To}. Upisali ste {PropertyValue}.",
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}' mora biti između {From} i {To} (ne uključujući granice). Upisali ste {PropertyValue}.",
                "CreditCardValidator" => "'{PropertyName}' nije odgovarajuća kreditna kartica.",
                "ScalePrecisionValidator" =>
                    "'{PropertyName}' ne smije imati više od {ExpectedPrecision} znamenki, sa {ExpectedScale} decimalna mjesta. Upisali ste {Digits} znamenki i {ActualScale} decimalna mjesta.",
