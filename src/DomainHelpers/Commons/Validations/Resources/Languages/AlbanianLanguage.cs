        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "GreaterThanOrEqualValidator" =>
                    "'{PropertyName}' duhet të jetë më e madhe se ose e barabartë me '{ComparisonValue}'.",
                "GreaterThanValidator" => "'{PropertyName}' duhet të jetë më e madhe se '{ComparisonValue}'.",
                "LengthValidator" =>
                    "'{PropertyName}' duhet të jetë midis {MinLength} dhe {MaxLength} karakteresh. Ju keni shkruar {TotalLength} karaktere.",
                "MinimumLengthValidator" =>
                    "Gjatësia e '{PropertyName}' duhet të jetë të paktën {MinLength} karaktere. Ju keni shkruar {TotalLength} karaktere.",
                "MaximumLengthValidator" =>
                    "Gjatësia e '{PropertyName}' duhet të jetë {MaxLength} karaktere ose më pak. Ju keni shkruar {TotalLength} karaktere.",
                "LessThanOrEqualValidator" =>
                    "'{PropertyName}'  duhet të jetë më e vogël ose e barabartë me '{ComparisonValue}'.",
                ...
                "ExactLengthValidator" =>
                    "'{PropertyName}' duhet të jetë {MaxLength} karaktere në gjatësi. Ju keni shkruar {TotalLength} karaktere.",
                "InclusiveBetweenValidator" =>
                    "'{PropertyName}' duhet të jetë midis {From} dhe {To}. Ju keni shkruar {PropertyValue}.",
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}' duhet të jetë midis {From} dhe {To} (përjashtuese). Ju keni shkruar {PropertyValue}.",
                "CreditCardValidator" => "'{PropertyName}' nuk është nje numër i vlefshëm karte krediti.",
                "ScalePrecisionValidator" =>
                    "'{PropertyName}' nuk mund të jetë më shumë se {ExpectedPrecision} shifra në total, me hapësirë për {ExpectedScale} shifra dhjetore. {Digits} shifra dhe {ActualScale} shifra dhjetore u gjetën.",
