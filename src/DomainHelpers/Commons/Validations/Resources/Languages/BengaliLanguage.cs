    ...
    internal class BengaliLanguage {
        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "LengthValidator" =>
                    "'{PropertyName}' এর অক্ষর সংখ্যা অবশ্যই {MinLength} থেকে {MaxLength} এর মধ্যে হবে। আপনি {TotalLength}টি অক্ষর প্রদান করেছেন।",
                "MinimumLengthValidator" =>
                    "'{PropertyName}' এর অক্ষর সংখ্যা কমপক্ষে {MinLength} অথবা এর চেয়ে বেশি হবে। আপনি {TotalLength}টি অক্ষর প্রদান করেছেন।",
                "MaximumLengthValidator" =>
                    "'{PropertyName}' এর অক্ষর সংখ্যা সর্বোচ্চ {MaxLength} অথবা এর চেয়ে কম হবে। আপনি {TotalLength}টি অক্ষর প্রদান করেছেন।",
                ...
                "ExactLengthValidator" =>
                    "'{PropertyName}' এর অক্ষর সংখ্যা অবশ্যই {MaxLength}টি হবে। আপনি {TotalLength}টি অক্ষর প্রদান করেছেন।",
                "InclusiveBetweenValidator" =>
                    "'{PropertyName}' অবশ্যই {From} থেকে {To} এর মধ্যে হবে। আপনি {PropertyValue} প্রদান করেছেন।",
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}' অবশ্যই {From} থেকে {To} এর বাহিরে হবে না। আপনি {PropertyValue} প্রদান করেছেন।",
                "CreditCardValidator" => "'{PropertyName}' বৈধ ক্রেডিট কার্ড সংখ্যা নয়।",
                "ScalePrecisionValidator" =>
                    "'{PropertyName}' মোট {ExpectedPrecision} অঙ্কের বেশি হবে না। {ExpectedScale} বৈধ দশমাংশ, কিন্তু প্রদত্ত {Digits} সংখ্যাটি {ActualScale} দশমাংশের",
                ...
                "MaximumLength_Simple" =>
                    "'{PropertyName}' এর অক্ষর সংখ্যা সর্বোচ্চ {MaxLength}টি অথবা এর চেয়ে কম হবে।",
