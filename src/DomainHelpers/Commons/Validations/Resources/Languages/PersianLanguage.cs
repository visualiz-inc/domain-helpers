    ...
    internal class PersianLanguage {
        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "LengthValidator" =>
                    "'{PropertyName}' باید حداقل {MinLength} و حداکثر {MaxLength} کاراکتر داشته باشد. اما مقدار وارد شده {TotalLength} کاراکتر دارد.",
                "MinimumLengthValidator" =>
                    "'{PropertyName}' باید بزرگتر یا برابر با {MinLength} کاراکتر باشد. شما تعداد {TotalLength} کاراکتر را وارد کردید",
                "MaximumLengthValidator" =>
                    "'{PropertyName}' باید کمتر یا مساوی {MaxLength} باشد. {TotalLength} را وارد کردید",
                ...
                "ExactLengthValidator" =>
                    "'{PropertyName}' باید دقیقا {MaxLength} کاراکتر باشد اما مقدار وارد شده {TotalLength} کاراکتر دارد.",
                "InclusiveBetweenValidator" =>
                    "'{PropertyName}' باید بین {From} و {To} باشد. اما مقدار وارد شده ({PropertyValue}) در این محدوده نیست.",
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}' باید بیشتر از {From} و کمتر از {To} باشد. اما مقدار وارد شده ({PropertyValue}) در این محدوده نیست.",
                "CreditCardValidator" => "'{PropertyName}' وارد شده معتبر نیست.",
                "ScalePrecisionValidator" =>
                    "'{PropertyName}' نباید بیش از {ExpectedPrecision} رقم، شامل {ExpectedScale} رقم اعشار داشته باشد. مقدار وارد شده {Digits} رقم و {ActualScale} رقم اعشار دارد.",
