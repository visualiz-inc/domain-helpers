        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "MinimumLengthValidator" =>
                    "'{PropertyName}' deve ser maior ou igual a {MinLength} caracteres. Você digitou {TotalLength} caracteres.",
                "MaximumLengthValidator" =>
                    "'{PropertyName}' deve ser menor ou igual a {MaxLength} caracteres. Você digitou {TotalLength} caracteres.",
                ...
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}' deve, exclusivamente, estar entre {From} e {To}. Você digitou {PropertyValue}.",
                ...
                "ScalePrecisionValidator" =>
                    "'{PropertyName}' não pode ter mais do que {ExpectedPrecision} dígitos no total, com {ExpectedScale} dígitos decimais. {Digits} dígitos e {ActualScale} decimais foram informados.",
