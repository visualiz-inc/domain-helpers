    ...
    internal class HebrewLanguage {
        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "LengthValidator" =>
                    "אורך '{PropertyName}' חייב להיות בין {MinLength} ל- {MaxLength}. הזנת {TotalLength} תווים.",
                "MinimumLengthValidator" =>
                    "אורך '{PropertyName}' חייב להיות לפחות {MinLength} תווים. הזנת {TotalLength} תווים.",
                "MaximumLengthValidator" =>
                    "אורך '{PropertyName}' חייב להיות {MaxLength} תווים או פחות. הזנת {TotalLength} תווים.",
                ...
                "ExactLengthValidator" =>
                    "'{PropertyName}' חייב להיות באורך {MaxLength} תווים. הזנת {TotalLength} תווים.",
                "InclusiveBetweenValidator" =>
                    "'{PropertyName}' חייב להיות בין {From} לבין {To}. הזנת {PropertyValue}.",
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}' חייב להיות בין {From} לבין {To} (לא כולל). הזנת {PropertyValue}.",
                "CreditCardValidator" => "'{PropertyName}' אינו מספר כרטיס אשראי חוקי.",
                "ScalePrecisionValidator" =>
                    "'{PropertyName}' לא יכול לכלול יותר מ- {ExpectedPrecision} ספרות בסך הכל, עם הקצבה של {ExpectedScale} ספרות עשרוניות. נמצאו {Digits} ספרות ו- {ActualScale} ספרות עשרוניות.",
