        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "GreaterThanOrEqualValidator" =>
                    "'{PropertyName}' harus lebih besar dari atau sama dengan '{ComparisonValue}'.",
                "GreaterThanValidator" => "'{PropertyName}' harus lebih besar dari '{ComparisonValue}'.",
                "LengthValidator" =>
                    "'{PropertyName}' harus di antara {MinLength} dan {MaxLength} karakter. Anda memasukkan {TotalLength} karakter.",
                "MinimumLengthValidator" =>
                    "Panjang dari '{PropertyName}' harus paling tidak {MinLength} karakter. Anda memasukkan {TotalLength} karakter.",
                "MaximumLengthValidator" =>
                    "Panjang dari '{PropertyName}' harus {MaxLength} karakter atau kurang. Anda memasukkan {TotalLength} karakter.",
                "LessThanOrEqualValidator" =>
                    "'{PropertyName}' harus kurang dari atau sama dengan '{ComparisonValue}'.",
                ...
                "ExactLengthValidator" =>
                    "'{PropertyName}' harus {MaxLength} karakter panjangnya. Anda memasukkan {TotalLength} karakter.",
                "InclusiveBetweenValidator" =>
                    "'{PropertyName}' harus di antara {From} dan {To}. Anda memasukkan {PropertyValue}.",
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}' harus di antara {From} dan {To} (exclusive). Anda memasukkan {PropertyValue}.",
                "CreditCardValidator" => "'{PropertyName}' bukan nomor kartu kredit yang benar.",
                "ScalePrecisionValidator" =>
                    "Jumlah digit '{PropertyName}' tidak boleh lebih dari {ExpectedPrecision}, dengan toleransi {ExpectedScale} desimal. {Digits} digit dan {ActualScale} desimal ditemukan.",
                "EmptyValidator" => "'{PropertyName}' harus kosong.",
                "NullValidator" => "'{PropertyName}' harus kosong.",
                "EnumValidator" =>
                    "'{PropertyName}' memiliki rentang nilai yang tidak mengikutsertakan '{PropertyValue}'.",
