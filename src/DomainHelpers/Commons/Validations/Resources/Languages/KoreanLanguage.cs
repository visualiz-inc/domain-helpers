        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "ExactLengthValidator" =>
                    "'{PropertyName}'은(는) {MaxLength} 글자이하의 문자열이어야 합니다. 입력한 문자열은 {TotalLength} 글자 입니다.",
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}'은(는) {From} 이상 {To} 미만이어야 합니다. 입력한 값은 {PropertyValue}입니다.",
                ...
                "InclusiveBetweenValidator" =>
                    "'{PropertyName}'은(는) {From} 이상 {To} 이하여야 합니다. 입력한 값은 {PropertyValue}입니다.",
                "LengthValidator" =>
                    "'{PropertyName}'은(는) {MinLength} 글자 이상 {MaxLength} 글자 이하여야 합니다. 입력한 문자열은 {TotalLength} 글자입니다.",
                ...
                "ScalePrecisionValidator" =>
                    "'{PropertyName}'은(는) 소수점 이하 {ExpectedScale}자리 이하, 총 {ExpectedPrecision}자리 이하의 숫자여야 합니다. 입력한 값은 소수점 이하 {ActualScale}자리이고 총 {Digits}자리입니다.",
