        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "GreaterThanOrEqualValidator" =>
                    "Wartość pola '{PropertyName}' musi być równa lub większa niż '{ComparisonValue}'.",
                "GreaterThanValidator" => "Wartość pola '{PropertyName}' musi być większa niż '{ComparisonValue}'.",
                "LengthValidator" =>
                    "Długość pola '{PropertyName}' musi się zawierać pomiędzy {MinLength} i {MaxLength} znaki(ów). Wprowadzono {TotalLength} znaki(ów).",
                "MinimumLengthValidator" =>
                    "Długość pola '{PropertyName}' musi być większa lub równa {MinLength} znaki(ów). Wprowadzono {TotalLength} znaki(ów).",
                "MaximumLengthValidator" =>
                    "Długość pola '{PropertyName}' musi być mniejszy lub równy {MaxLength} znaki(ów). Wprowadzono {TotalLength} znaki(ów).",
                "LessThanOrEqualValidator" =>
                    "Wartość pola '{PropertyName}' musi być równa lub mniejsza niż '{ComparisonValue}'.",
                ...
                "ExactLengthValidator" =>
                    "Pole '{PropertyName}' musi posiadać długość {MaxLength} znaki(ów). Wprowadzono {TotalLength} znaki(ów).",
                ...
                "ExclusiveBetweenValidator" =>
                    "Wartość pola '{PropertyName}' musi się zawierać pomiędzy {From} i {To} (wyłącznie). Wprowadzono {PropertyValue}.",
                "CreditCardValidator" => "Pole '{PropertyName}' nie zawiera poprawnego numer karty kredytowej.",
                "ScalePrecisionValidator" =>
                    "Wartość pola '{PropertyName}' nie może mieć więcej niż {ExpectedPrecision} cyfr z dopuszczalną dokładnością {ExpectedScale} cyfr po przecinku. Znaleziono {Digits} cyfr i {ActualScale} cyfr po przecinku.",
                ...
                "Length_Simple" =>
                    "Długość pola '{PropertyName}' musi się zawierać pomiędzy {MinLength} i {MaxLength} znaki(ów).",
                "MinimumLength_Simple" =>
                    "Długość pola '{PropertyName}' musi być większa lub równa {MinLength} znaki(ów).",
                "MaximumLength_Simple" =>
                    "Długość pola '{PropertyName}' musi być mniejszy lub równy {MaxLength} znaki(ów).",
