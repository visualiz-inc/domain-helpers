        ...
        public static string? GetTranslation(string key) {
            return key switch {
                ...
                "GreaterThanOrEqualValidator" =>
                    "'{PropertyName}' verður að vera meiri en eða jöfn '{ComparisonValue}'.",
                "GreaterThanValidator" => "'{PropertyName}' verður að vera meiri en '{ComparisonValue}'.",
                "LengthValidator" =>
                    "'{PropertyName}' verður að vera á milli {MinLength} og {MaxLength} stafir. Þú slóst inn {TotalLength} stafi.",
                "MinimumLengthValidator" =>
                    "Lengdin '{PropertyName}' verður að vera að minnsta kosti {MinLength} stafir. Þú slóst inn {TotalLength} stafi.",
                "MaximumLengthValidator" =>
                    "Lengd '{PropertyName}' verður að vera {MaxLength} stafir eða færri. Þú slóst inn {TotalLength} stafi.",
                "LessThanOrEqualValidator" =>
                    "'{PropertyName}' verður að vera minna en eða jafnt og '{ComparisonValue}'.",
                ...
                "ExactLengthValidator" =>
                    "'{PropertyName}' verður að vera {MaxLength} stafir að lengd. Þú slóst inn {TotalLength} stafi.",
                "InclusiveBetweenValidator" =>
                    "'{PropertyName}' verður að frá {From} til {To}. Þú slóst inn {PropertyValue}.",
                "ExclusiveBetweenValidator" =>
                    "'{PropertyName}' verður að vera á milli {From} og {To}. Þú slóst inn {PropertyValue}.",
                "CreditCardValidator" => "'{PropertyName}' er ekki gilt kreditkortanúmer.",
                "ScalePrecisionValidator" =>
                    "'{PropertyName}' má ekki vera meira en {ExpectedPrecision} tölustafir samtals, með heimild fyrir {ExpectedScale} aukastöfum. {Digits} tölustafir og {ActualScale} aukastafir fundust.",
                ...
                "MinimumLength_Simple" =>
                    "Lengdin '{PropertyName}' verður að vera að minnsta kosti {MinLength} stafir.",
