...
public abstract class AbstractValidator<T> : IValidator<T>, IEnumerable<IValidationRule> {
    ...
    /// </para>
    /// <para>
    /// If set to <see cref="DomainHelpers.Core.Validations.CascadeMode.Continue"/> then all rules in the class will execute regardless of failures.
    /// </para>
    /// <para>
    /// If set to <see cref="DomainHelpers.Core.Validations.CascadeMode.Stop"/> then execution of the validator will stop after any rule fails.
    /// </para>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// This cannot be set to the deprecated <see cref="DomainHelpers.Core.Validations.CascadeMode.StopOnFirstFailure"/>.
    /// <see cref="DomainHelpers.Core.Validations.CascadeMode.StopOnFirstFailure"/>. Attempting to do so it will actually
    ...
    /// <see cref="DefaultValidatorOptions.Cascade{T, TProperty}(IRuleBuilderInitial{T, TProperty}, DomainHelpers.Core.Validations.CascadeMode)"/>.
