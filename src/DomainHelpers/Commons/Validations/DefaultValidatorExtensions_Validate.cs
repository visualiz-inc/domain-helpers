...
namespace DomainHelpers.Core.Validations {
    public static partial class DefaultValidatorExtensions {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static Task<ValidationResult> ValidateAsync<T>(this IValidator<T> validator, T instance,
            Action<ValidationStrategy<T>> options, CancellationToken cancellation = default) {
